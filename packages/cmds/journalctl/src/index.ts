// spec — types only from this barrel, same reasoning as @cmdgen/systemctl's index.ts.
...
// identical note in @cmdgen/systemctl's index.ts. Reach it via "@cmdgen/journalctl/definition".
