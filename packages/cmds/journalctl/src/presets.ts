...
export const PRESETS: readonly Preset<JournalctlSpec>[] = [
  {
    ...
    apply: (spec) => ({ ...spec, unit: "nginx", flags: { follow: true } }),
  },
  {
    id: "last-100-lines",
    ...
    apply: (spec) => ({ ...spec, unit: "nginx", flags: { lines: 100 } }),
  },
  {
    ...
    apply: (spec) => ({ ...spec, unit: "", flags: { boot: true, priority: "err" } }),
  },
  {
    id: "kernel-messages",
    ...
    apply: (spec) => ({ ...spec, unit: "", flags: { dmesg: true } }),
  },
  {
    id: "time-window",
