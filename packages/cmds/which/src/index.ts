// spec — types only from this barrel, same reasoning as @cmdgen/whereis's index.ts.
...
// identical note in @cmdgen/whereis's index.ts. Reach it via "@cmdgen/which/definition".
