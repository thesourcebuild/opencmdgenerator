// spec — types only from this barrel, same reasoning as @cmdgen/chown's index.ts.
...
// identical note in @cmdgen/chown's index.ts. Reach it via "@cmdgen/chgrp/definition".
