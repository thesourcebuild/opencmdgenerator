// spec — types only from this barrel, same reasoning as @cmdgen/whatis's index.ts.
...
// identical note in @cmdgen/whatis's index.ts. Reach it via "@cmdgen/history/definition".
