...
import type { HeadPlatform } from "./spec";
 ...
 */
export function renderTokens(argv: Argv, platform: HeadPlatform): RenderedToken[] {
  return renderTokensGeneric(argv, { shell: toShellDialect(platform) });
}

export function renderOneLine(argv: Argv, platform: HeadPlatform): string {
  return renderOneLineGeneric(argv, { shell: toShellDialect(platform) });
}

export function renderMultiLine(argv: Argv, platform: HeadPlatform): string {
