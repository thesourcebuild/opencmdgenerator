// spec — types only from this barrel, same reasoning as @cmdgen/useradd's index.ts.
...
// identical note in @cmdgen/useradd's index.ts. Reach it via "@cmdgen/groupadd/definition".
