// spec — types only from this barrel, same reasoning as @cmdgen/less's index.ts.
...
// identical note in @cmdgen/less's index.ts. Reach it via "@cmdgen/source/definition".
