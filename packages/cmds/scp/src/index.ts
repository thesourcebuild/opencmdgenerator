// spec — types only from this barrel, same reasoning as @cmdgen/ssh's and
// @cmdgen/rsync's index.ts.
...
// identical note in @cmdgen/ssh's index.ts. Reach it via "@cmdgen/scp/definition".
