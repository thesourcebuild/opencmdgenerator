// spec — types only from this barrel, same reasoning as @cmdgen/which's index.ts.
...
// identical note in @cmdgen/which's index.ts. Reach it via "@cmdgen/where/definition".
