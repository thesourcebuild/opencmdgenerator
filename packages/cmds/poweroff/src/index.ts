// spec — types only from this barrel, same reasoning as @cmdgen/halt's index.ts.
...
// identical note in @cmdgen/halt's index.ts. Reach it via "@cmdgen/poweroff/definition".
