// spec — types only from this barrel, same reasoning as @cmdgen/mkdir's index.ts.
...
// identical note in @cmdgen/mkdir's index.ts. Reach it via "@cmdgen/rmdir/definition".
