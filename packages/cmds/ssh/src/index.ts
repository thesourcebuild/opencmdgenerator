// spec — types only from this barrel, same reasoning as @cmdgen/rsync's and
// @cmdgen/cd's index.ts.
...
// identical note in @cmdgen/rsync's index.ts. Reach it via "@cmdgen/ssh/definition".
