// spec — types only from this barrel, same reasoning as @cmdgen/man's index.ts.
...
// identical note in @cmdgen/man's index.ts. Reach it via "@cmdgen/rsyslogd/definition".
