// spec — types only from this barrel, same reasoning as @cmdgen/mount's index.ts.
...
// identical note in @cmdgen/mount's index.ts. Reach it via "@cmdgen/updatedb/definition".
