...
/**
 * service has zero catalogue flags — its entire syntax is two bare words,
 * `service NAME ACTION`, with no `-flag` involved anywhere (see
 ...
 * — same reasoning as `@cmdgen/dd`'s `catalogue/groups.ts`.
 */
