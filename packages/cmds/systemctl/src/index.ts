// spec — types only from this barrel, same reasoning as @cmdgen/service's index.ts.
...
// identical note in @cmdgen/service's index.ts. Reach it via "@cmdgen/systemctl/definition".
