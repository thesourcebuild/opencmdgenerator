...
export const PRESETS: readonly Preset<SystemctlSpec>[] = [
  {
    ...
    apply: (spec) => ({ ...spec, unit: "nginx", targets: [], extraOptions: [], action: "restart", flags: {} }),
  },
  {
    id: "check-status",
    ...
    apply: (spec) => ({ ...spec, unit: "nginx", targets: [], extraOptions: [], action: "status", flags: {} }),
  },
  {
    id: "enable-at-boot",
    ...
    apply: (spec) => ({ ...spec, unit: "nginx", targets: [], extraOptions: [], action: "enable", flags: {} }),
  },
  {
    id: "stop-a-unit",
    label: "Stop a unit",
    ...
    apply: (spec) => ({ ...spec, unit: "nginx", targets: [], extraOptions: [], action: "stop", flags: {} }),
  },
  {
    id: "reload-daemon",
    ...
    apply: (spec) => ({ ...spec, unit: "", targets: [], extraOptions: [], action: "daemon-reload", flags: {} }),
  },
];
