// spec — types only from this barrel, same reasoning as @cmdgen/killall's index.ts.
...
// identical note in @cmdgen/killall's index.ts. Reach it via "@cmdgen/whereis/definition".
