// spec — types only from this barrel, same reasoning as @cmdgen/gzip's index.ts.
...
// identical note in @cmdgen/gzip's index.ts. Reach it via "@cmdgen/gunzip/definition".
