...
// generic engine renderer works directly, same reasoning as @cmdgen/touch's
// and @cmdgen/top's index.ts, so no custom render.ts is needed.)
export {
  quotePosix,
  quotePowerShell,
  quoteCmd,
...
// identical note in @cmdgen/touch's index.ts. Reach it via "@cmdgen/iptables/definition".
