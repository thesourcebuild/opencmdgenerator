...
import { buildArgv, lint, renderTokens } from "@cmdgen/export";
import { GeneratedCommandPanel } from "./generated-command-panel";
import { isWindows } from "./export-target-selector";

const CONTINUATION: Record<ExportPlatform, string> = {
  linux: " \\",
  mac: " \\",
  "windows-cmd": " ^",
  "windows-powershell": " `",
...
/** Only the Windows sub-choices — "posix" is picked via the Linux/Mac buttons in `ExportTargetSelector`, not here. */
...
/** export's data for the shared `GeneratedCommandPanel` template — same shape as `@cmdgen/mv`'s preview. */
export function ExportPreview({ spec, onPlatformChange }: ExportPreviewProps) {
