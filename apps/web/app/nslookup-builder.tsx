...
import { NslookupPreview } from "./nslookup-preview";

export function NslookupBuilder() {
  const [spec, setSpec] = useState<NslookupSpec>(() => createSpec({ id: "draft" }));
  const [activePreset, setActivePreset] = useState<Preset<NslookupSpec> | null>(null);

  return (
    <div className="flex gap-4">
      <div className="min-w-0 flex-1 space-y-4">
        <div className="sticky top-0 z-10 bg-slate-50 pb-4 dark:bg-slate-950">
          <NslookupPreview spec={spec} />
        </div>
