...
import type { TailPlatform } from "@cmdgen/tail";
import { Panel, cn } from "@cmdgen/ui";

export const isWindows = (p: TailPlatform) =>
...
export function TailTargetSelector({ value, onChange }: { value: TailPlatform; onChange: (next: TailPlatform) => void }) {
  return (
