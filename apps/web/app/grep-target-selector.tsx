...
export const isWindows = (p: GrepPlatform) =>
...
export function GrepTargetSelector({ value, onChange }: { value: GrepPlatform; onChange: (next: GrepPlatform) => void }) {
  return (
