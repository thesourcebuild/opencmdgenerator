...
export const isWindows = (p: CatPlatform) =>
...
export function CatTargetSelector({ value, onChange }: { value: CatPlatform; onChange: (next: CatPlatform) => void }) {
  return (
