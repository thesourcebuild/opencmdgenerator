...
import { UniqPreview } from "./uniq-preview";

export function UniqBuilder() {
  const [spec, setSpec] = useState<UniqSpec>(() => createSpec({ id: "draft" }));
  const [activePreset, setActivePreset] = useState<Preset<UniqSpec> | null>(null);

  return (
    <div className="flex gap-4">
      <div className="min-w-0 flex-1 space-y-4">
        <div className="sticky top-0 z-10 bg-slate-50 pb-4 dark:bg-slate-950">
          <UniqPreview spec={spec} />
        </div>
