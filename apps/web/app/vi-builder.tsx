...
import { CATALOGUE, FLAG_GROUP_META, PRESETS, createSpec, describeSpec, lint, setFlag } from "@cmdgen/vi";
...
export function ViBuilder() {
  const [spec, setSpec] = useState<ViSpec>(() => createSpec({ id: "draft" }));
  const [activePreset, setActivePreset] = useState<Preset<ViSpec> | null>(null);
