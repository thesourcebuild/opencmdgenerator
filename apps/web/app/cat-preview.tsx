...
import { buildArgv, lint, renderTokens } from "@cmdgen/cat";
import { GeneratedCommandPanel } from "./generated-command-panel";
import { isWindows } from "./cat-target-selector";

const CONTINUATION: Record<CatPlatform, string> = {
  linux: " \\",
  mac: " \\",
  "windows-cmd": " ^",
  "windows-powershell": " `",
...
/** Only the Windows sub-choices — "posix" is picked via the Linux/Mac buttons in `CatTargetSelector`, not here. */
...
/** cat's data for the shared `GeneratedCommandPanel` template — same shape as `@cmdgen/mv`'s preview. */
export function CatPreview({ spec, onPlatformChange }: CatPreviewProps) {
