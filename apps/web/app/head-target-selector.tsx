...
import type { HeadPlatform } from "@cmdgen/head";
import { Panel, cn } from "@cmdgen/ui";

export const isWindows = (p: HeadPlatform) =>
...
export function HeadTargetSelector({ value, onChange }: { value: HeadPlatform; onChange: (next: HeadPlatform) => void }) {
  return (
