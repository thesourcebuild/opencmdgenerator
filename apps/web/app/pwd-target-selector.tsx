...
import type { PwdPlatform } from "@cmdgen/pwd";
import { Panel, cn } from "@cmdgen/ui";

export const isWindows = (p: PwdPlatform) =>
...
export function PwdTargetSelector({ value, onChange }: { value: PwdPlatform; onChange: (next: PwdPlatform) => void }) {
  return (
