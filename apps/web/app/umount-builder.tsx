...
import { UmountPreview } from "./umount-preview";

export function UmountBuilder() {
  const [spec, setSpec] = useState<UmountSpec>(() => createSpec({ id: "draft" }));
  const [activePreset, setActivePreset] = useState<Preset<UmountSpec> | null>(null);

  return (
    <div className="flex gap-4">
      <div className="min-w-0 flex-1 space-y-4">
        <div className="sticky top-0 z-10 bg-slate-50 pb-4 dark:bg-slate-950">
          <UmountPreview spec={spec} />
        </div>
