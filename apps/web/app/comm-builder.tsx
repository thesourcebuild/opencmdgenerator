...
export function CommBuilder() {
  const [spec, setSpec] = useState<CommSpec>(() => createSpec({ id: "draft" }));
  const [activePreset, setActivePreset] = useState<Preset<CommSpec> | null>(null);

  return (
    <div className="flex gap-4">
      <div className="min-w-0 flex-1 space-y-4">
        <div className="sticky top-0 z-10 bg-slate-50 pb-4 dark:bg-slate-950">
          <CommPreview spec={spec} />
        </div>
        ...
        <Panel title="Commands" collapsible defaultOpen>
          <div className="space-y-4">
            ...
            <Panel title="Files" description="Both must already be sorted.">
