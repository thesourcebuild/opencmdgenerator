...
import { YumPreview } from "./yum-preview";

export function YumBuilder() {
  const [spec, setSpec] = useState<YumSpec>(() => createSpec({ id: "draft" }));
  const [activePreset, setActivePreset] = useState<Preset<YumSpec> | null>(null);

  return (
    <div className="flex gap-4">
      <div className="min-w-0 flex-1 space-y-4">
        <div className="sticky top-0 z-10 bg-slate-50 pb-4 dark:bg-slate-950">
          <YumPreview spec={spec} />
        </div>
          ...
          <div className="space-y-4">
            ...
            <Panel title="Packages">
              <StringListEditor
                ...
                emptyHint="No packages added — install, remove, and search need at least one package name (update does not)."
              />
            </Panel>
